...
- **Dtos** — DTO, используемые в сервисах и для работы API:
  - `BookDto` — DTO карточки книги, с дополнительной информацией
  - `BorrowRecordDto` — DTO записи о выдаче книги, с дополнительной информацией
  - `CustomerDto` — DTO читателя, с дополнительной информацией.
