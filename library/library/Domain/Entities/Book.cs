...
public class Book {
    ...
    public Book(string code, string author, string name, int year, Publisher publisher, PublisherType publisherType) {
    ...
    public void Update(string name, string author, int publicationYear, Publisher publisher, PublisherType pusblisherType) {
        Name = name;
        Author = author;
